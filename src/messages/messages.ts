...
export const validateDatasMessages = {
  ...
  rol: {
    ...
    isNotEmpty: 'You cant leave this field empty',
    typeRol: 'you must write some Rol',
    rolEnum,
  },
  identification: {
  ...
  primaryColor: {
    ...
    isNotEmpty: 'You cant leave el color primary vacio',
  },

  secondaryColor: {
    isString: 'the secondaryColor  is string',
    isNotEmpty: 'You cant leave el color secondary empty',
  },

  font: {
    isString: 'the font  is string',
    isNotEmpty: 'You cant leave the font empty',
  },
  gender: {
